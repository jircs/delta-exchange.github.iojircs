...
| showWhenLogin | Show the card only when user is logged in or logged out state or both. If not specified then card is shown in all the states. | "pre" or "post" | "showWhenLogin" : "pre" | Only Image Card | Optional |
